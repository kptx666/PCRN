...
parser.add_argument("--test_hr_folder", type=str, default='Test_Datasets/BSD100/',
                    help='the folder of the target images')
parser.add_argument("--test_lr_folder", type=str, default='Test_Datasets/BSD100_LR/x3/',
                    help='the folder of the input images')
parser.add_argument("--output_folder", type=str, default='results/BSD100/x3')
...
model = LNA_SR(upscale_factor=opt.upscale_factor)
